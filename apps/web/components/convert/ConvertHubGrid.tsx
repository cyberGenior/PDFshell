...
/** The interactive grid of conversion cards (client island for the hub page). */
export function ConvertHubGrid() {
  return (
    <>
          ...
          return (
            ...
            >
              ...
              >
                ...
                <p className="mt-1 flex-1 text-sm leading-relaxed text-[var(--muted-foreground)]">{c.description}</p>
                {c.engine === 'client' && (
