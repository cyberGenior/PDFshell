...
const nextConfig = {
  ...
  // Long-cache immutable, content-hashed assets and the brand icons/OG image at
  // the edge (behind Cloudflare) so repeat visits on metered mobile data cost
  ...
  async headers() {
    ...
    return [
      ...
      { source: '/android-chrome-:size.png', headers: [{ key: 'Cache-Control', value: oneWeek }] },
